export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'HuynhVanDe MERN Stack Board',
    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-01', 'card-id-02', 'card-id-03', 'card-id-07', 'card-id-04', 'card-id-05', 'card-id-06'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'https://cdn.explorecams.com/storage/photos/KCOUKFgKBg_1600.jpg',
